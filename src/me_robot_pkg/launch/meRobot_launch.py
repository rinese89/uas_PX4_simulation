...
def generate_launch_description():
    ...
    urdf_file_1  =  os.path.join(pkg_project, 'urdf', 'mebot1.urdf')
    with open(urdf_file_1, 'r') as infp:
        robot_desc_1 = infp.read()
    
    urdf_file_2  =  os.path.join(pkg_project, 'urdf', 'mebot2.urdf')
    with open(urdf_file_2, 'r') as infp:
    ...
    robot_state_publisher_2 = Node(
        ...
        remappings=[
        ('/robot_description', '/mebot2/robot_description'),
        ('/joint_states','/mebot2/joint_states'),
        ]
        )
